...
function ScenarioList({
  ...
  // 탭별 시나리오 개수 계산 (날짜 필터가 있으면 필터링된 개수, 없으면 탭별 전체 개수)
  const scenarioCount = hasDateFilter ? filteredItems.length : (totalScenarios > 0 ? totalScenarios : filteredItems.length)
